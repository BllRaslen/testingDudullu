describe('Login', () => {
    ...
    it('should contain navigation links', () => {
        ...
        cy.get('.mui-6qshaz > :nth-child(2) > .MuiGrid-container > .MuiGrid-grid-xs-4').click()
        cy.get(':nth-child(3) > .MuiGrid-container > .MuiGrid-grid-xs-4').click()
        cy.get(':nth-child(4) > .MuiGrid-container > .MuiGrid-grid-xs-4').click()

        cy.get(':nth-child(2) > .MuiCardHeader-root > .MuiCardHeader-action > .MuiStack-root > .MuiButton-root').click()
